...
function [D_nu,terms]=parafunc_C(nu,z)
    ...
    for i=1:length(z)
        ...
        terms(1,i)=sqrt(pi)*F11(-nu/2,1/2,z(i)^2/2,12)/double(feval(symengine,'gamma',(1-nu)/2));
        terms(2,i)=sqrt(2*pi)*z(i)*F11((1-nu)/2,3/2,z(i)^2/2,12)/double(feval(symengine,'gamma',-nu/2));
